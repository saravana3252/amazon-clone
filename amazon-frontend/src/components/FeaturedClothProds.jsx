...
useEffect(()=>{
 setIsLoading(true)
  fetch("https://amazon-clone-backend-mxip.onrender.com/featuredClothingProducts").then((response)=>response.json()).then((data)=>{
    ...
    return (
        <>
        <div className="bg-gray-200 w-full lg:pb-12 pb-10 px-4">
            <div className="bg-white relative w-full  px-3 py-2 group">
                ...
                <div id="scrollContainer4" className="w-full mt-4 lg:mt-3 flex overflow-x-auto scrollbar-hide space-x-10 cursor-pointer">
                    {
