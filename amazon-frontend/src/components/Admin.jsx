  ...
  function handleToggle(){
    ...
    return (
        ...
        <div id="mobileNav" className={`bg-gray-700 min-h-full fixed top-0 w-[50%] transition-all duration-300 ${toggle ? "left-0" : "-left-[50%]"} lg:hidden`}>
                ...
                <Link to="/admin" className="hover:bg-gray-600 p-2 pl-6 mx-2   rounded transition-all duration-300 cursor-pointer">Products List</Link>
                <Link to="/admin/admin-orders" className="hover:bg-gray-600 p-2 pl-6   mx-2 rounded transition-all duration-300 cursor-pointer">Orders List</Link>
