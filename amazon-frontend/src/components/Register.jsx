    ...
    return(
        ...
        <div className="bg-white h-screen w-full flex flex-col items-center pt-20 p-5 lg:p-0 lg:pt-10">
           ...
           <form>
            ...
            <input name="name" type="text" className="p-2 border border-black outline-none focus:ring-2 focus:ring-blue-500" placeholder="enter your name" required value={name}  onChange={(e)=>{setName(e.target.value)}} autoComplete="off"></input>
            <input name="email" type="email" className="p-2 border border-black outline-none focus:ring-2 focus:ring-blue-500" placeholder="enter your email" required value={email} onChange={(e)=>{setEmail(e.target.value)}} autoComplete="off"></input>
