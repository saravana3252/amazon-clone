       ...
       mobileFilters.style.left="-100%"
        ...
        <div id="desktopFilters" className="bg-gray-200 p-4 hidden lg:block">
          <div className="bg-white p-4 rounded">
            ...
            <div className="flex flex-col mt-2">
              <label className="flex items-center space-x-2">
                <input type="checkbox" value="150" onChange={(e)=>{
                    if(e.target.checked){
                      setFilterData(e.target.value)
                    }
                    else{
                ...
                <span>Less than Rs 150</span>
              </label>
              <label className="flex items-center space-x-2 pt-1">
                <input type="checkbox" value="250" onChange={(e)=>{
                    if(e.target.checked){
                      setFilterData(e.target.value)
                    }
                    else{
