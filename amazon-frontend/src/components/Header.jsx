      ...
      <div className="lg:hidden w-[25%] flex justify-center items-center  cursor-pointer">
        ...
        <div id="mobileNav" className="fixed z-50 lg:hidden transition-all duration-500 top-0 -left-[70%] bg-gray-800  min-h-screen w-[70%]">
         ...
         <div className="bg-gray-600 p-2 mt-4  text-center font-medium text-white cursor-pointer" onClick={handleCategoryToggle}>
            ...
            <div className={`transition-opacity duration-300 delay-200 flex flex-col space-y-4 pt-2 ${isOpen ? "opacity-100 translate-x-0" : "opacity-0 -translate-64"}`}>
        ...
        <div className="lg:w-[55%] w-[75%]   h-20  lg:flex hidden justify-center items-center">
          <div className="bg-orange-500 w-[95%] h-10 flex items-center rounded">
            <div className="w-[90%] relative">
              <div
                id="searchDataDiv"
                className="absolute z-30 top-11 w-full py-2 space-y-1 bg-white"
              >
      ...
      <div className="w-[95%]   h-10  lg:hidden flex justify-center items-center">
          <div className="bg-orange-500 w-[95%] h-10 flex items-center rounded">
            <div className="w-[80%] relative">
              <div
                id="searchDataDiv1"
                className="absolute z-30 top-11 w-full py-2 space-y-1 border-b-6 border-l-4 border-orange-500 bg-white"
              >
                {inpSearchData.length > 0 ? (
                  inpSearchData.map((data, index) => {
                    return (
