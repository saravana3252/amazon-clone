    ...
    return(
        ...
        <div className="bg-white h-screen w-full flex flex-col pt-24 p-5 lg:p-0 items-center lg:pt-10">
           ...
           <form >
            ...
            <input name="email"  type="email" className="p-2 border border-black outline-none" placeholder="enter your email" required onChange={(e)=>{setEmail(e.target.value)}}></input>
            <div className="flex border border-black">
            <input id="password" name="password" type="password" className="p-2 outline-none w-[80%]" placeholder="enter your password" required onChange={(e)=>{setPassword(e.target.value)}}></input>
