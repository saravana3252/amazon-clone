...
function scrollLeft(){
    let scrollContainer = document.getElementById("scrollContainer3")
    ...
    return (
        ...
        <div className="bg-gray-200 w-full lg:pt-12 pt-10 px-4">
            <div className="bg-white relative w-full px-3 py-2 group">
                <h1 className="font-bold lg:text-2xl text-xl">Popular products in Toys</h1>
                ...
                <div id="scrollContainer3" className="w-full mt-4 lg:mt-3 flex overflow-x-auto scrollbar-hide space-x-10 lg:space-x-16 cursor-pointer">
...
FeaturedToyProds.propTypes = {
    productdes : PropTypes.func.isRequired
}

export default FeaturedToyProds